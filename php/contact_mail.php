<?php
	...
	if($api->listSubscribe($list_id, $email) === true) {
		$sendstatus = 1;
		$message = '<div class="alert alert-success subscription-success" role="alert"><strong>Success!</strong> Revisa tu correo electrónico para confirmar el registro.</div>';
	} else {
		$sendstatus = 0;
